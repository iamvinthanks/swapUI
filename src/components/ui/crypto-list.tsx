...
// );
const CryptoSelectView = dynamic(
  () => import('@/components/ui/crypto-select-view')
);
...
export default function Userrek({
  label,
  getCoinValue,
  defaultCoinIndex = 0,
  exchangeRate,
  ...
  let [selectedCoin, setSelectedCoin] = useState(rekList[defaultCoinIndex]);
...
Userrek.displayName = 'cryptoList';
